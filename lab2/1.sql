...
DATAFILE 'C:\tablespaces\TS_KVS.dbf'
SIZE 7 m
...
TEMPFILE 'C:\tablespaces\TS_KVS_TEMP.dbf'
SIZE 5 m
...
DROP PROFILE PF_KVSCORE cascade;
...
SELECT * FROM ALL_USERS WHERE USERNAME = 'KVSCORE'
...
DROP TABLESPACE KVS_QDATA INCLUDING CONTENTS
commit;
